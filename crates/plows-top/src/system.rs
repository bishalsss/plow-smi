//! System metrics collection — delegates to plows-exporter's SystemCollector.

use plows_exporter::collector::system::{SystemCollector as ExporterSystemCollector, SystemSnapshot};
